      ...
      >
        <div className="max-w-lg mx-auto">
          <motion.h1 
            ...
            whileInView={{ 
              textShadow: ["0px 0px 0px rgba(0,0,0,0)", "0px 2px 4px rgba(0,0,0,0.1)", "0px 0px 0px rgba(0,0,0,0)"] 
            }}
          ...
          >
            Arch Point addresses new ways of understanding the often interrelations between the vital energy and built form. At Arch Point we provide Architectural, Interior and Residential services for which we are committed to holding your hands throughout the project to meet your unique specifications.
          </motion.p>
        ...
        >
          ...
          {images.map((image, index) => (
            <motion.div 
              ...
              initial={{ opacity: 0, scale: index === currentSlide ? 1.1 : 1 }}
              animate={{ 
